...
import {delete_product, mans_products} from "../Axios/shop";
...
const MansPage = () =>{
    ...
    const [mansProducts, setMansProducts] = useState([])
    ...
    useEffect(() => {
        mans_products(setMansProducts)
    }, [])

    const products = mansProducts.map(element => {
        return (
            <div className="card">
